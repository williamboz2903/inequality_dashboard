...
than an actual fall in the difference between the regions’ productivity levels."""
    ...
    ANALYSIS_PAY_VS_INACTIVITY = """Raw data(Median Pay) : https://www.ons.gov.uk/filters/412e9c37-c103-4622-ab45-1efe6bf0d15b/dimensions

Raw data(Inactivity): https://www.ons.gov.uk/explore-local-statistics/indicators/economic-inactivity-rate

This scatter plot has a regression line that slopes downwards, indicating that there is a weak negative correlation. This implies that as median pay increases, the rate of economic inactivity falls. This seems to support traditional economic theory. Logically, higher wages should incentivise people to seek employment rather than remain economically inactive. (In strict economic terms, this is because with a higher wage, the opportunity cost of not working rises.) As such, this should lead to more people entering the workforce in order to receive these higher wages. This should leave them with significantly more income than remaining inactive and on benefits. Consequently, they will be able to increase their consumption of goods and services (higher utility). As it is assumed greater consumption is preferable, this should increase a person's satisfaction (economic welfare). Therefore, the negative correlation between the median pay and economic inactivity rate seems to support this logic.

Nonetheless, we have to be careful with drawing conclusions. To start with, the majority of the scatter points are between a median pay of £20000-£25000. We have very few scatter points for the higher ranges of median pay. Due to this, this correlation isn’t completely reliable due to a low sample size of data for higher median pay values above £30000. This is compounded by the fact that we only have 8 years of data, so it is difficult to suggest that, with so few years to test this correlation, there is a definitive link between the two variables.

Furthermore, the correlation itself is fairly weak. We can likely argue that this suggests there are other reasons why the inactivity rate of certain regions may be higher than others beyond different levels of median pay. For instance, it has been suggested in recent years that, following Covid, there has been a significant rise in long-term sickness which prevents people from re-entering the workforce. This might suggest that low wages may not necessarily be the main cause for certain regions having higher economic inactivity rates, and other factors can have significant impacts.
...
"""
    ...
    ANALYSIS_PAY_VS_PRODUCTIVITY = """ Raw data(Median Pay): https://www.ons.gov.uk/filters/412e9c37-c103-4622-ab45-1efe6bf0d15b/dimensions

Raw data(Productivity): https://www.ons.gov.uk/explore-local-statistics/indicators/gross-value-added-per-hour-worked
    
This scatter plot has a regression line with a steep upwards slope , indicating a strong positive correlation between median pay and productivity. Economic theory argues that a rise in productivity , which raises the amount of output a firm can produce holding all other inputs constant , should result in firms paying higher wages to their employees. Consequently , we would expect there to be a strong positive correlation , which the data we have seems to support.
...
As stated earlier, given we have so few scatter points above £30000, this low sample size limits the reliability of our scatter plot.
Additionally, there could be other rational economic reasons to argue against this supposed causation. For instance, due to inflation reducing the value of real wages, workers may demand increases to their wages or threaten strike action in order to prevent a decrease in their purchasing power. As such , the firm may be forced to pay higher wages to their workers, but their productivity may not have increased.
Additionally, the last few years have seen a severe rise in the usage of artificial intelligence, with many predicting it will lead to large rises in productivity. Yet, in spite of the fact its usage over the last years has been increasing, with more firms reducing the size of their workforces, we have not seen large rises in wages, implying that for certain technological improvements the correlation may not hold.
