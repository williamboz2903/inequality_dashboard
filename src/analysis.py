...
in economic inactivity between the regions has consistently been decreasing, rather it has variated a lot."""
...
One could sya that this should imply the productivity gap between the regions has lowered. Nonetheless,
